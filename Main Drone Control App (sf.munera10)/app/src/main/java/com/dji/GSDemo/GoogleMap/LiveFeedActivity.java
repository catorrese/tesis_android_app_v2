...
public class LiveFeedActivity extends AppCompatActivity implements TextureView.SurfaceTextureListener, View.OnClickListener{
    ...
    private static final String TAG = LiveFeedActivity.class.getName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tasksUploaded = getIntent().getExtras().getBoolean("TASKS");
        initUI();
        handler = new Handler();
        /*
            ...
            camera.setSystemStateCallback(new SystemState.Callback() {
                ...
                public void onUpdate(SystemState cameraSystemState) {
                    if (null != cameraSystemState) {
                        ...
                        LiveFeedActivity.this.runOnUiThread(new Runnable() {
